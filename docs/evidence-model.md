...
- `artifacts/`: private raw preservation outputs such as mirror files, WARC/WACZ, explicit WACZ page index input, screenshots, PDFs, downloads, and SingleFile HTML.
